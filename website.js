module.exports = {
  ...
  description: `Designer, Web Developer, and JavaScript specialist - I am William Wittenbrock and this is my blog. Check out my latest posts.`,
  ...
  logo: `https://res.cloudinary.com/wittenbrock-design/image/upload/v1598739949/wittenbrock-design/wittenbrock-logo-4096x4096_kr6yci.png`, // Used for SEO
  ogLanguage: `en_US`, // Facebook Language

  // JSONLD / Manifest
  favicon: `src/images/favicon.png`, // Used for manifest favicon generation
  shortName: `Wittenbrock Design`, // shortname for manifest. MUST be shorter than 12 characters

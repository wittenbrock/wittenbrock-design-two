...
const ContactIcon = ({size, height, width, color}) => (
  <div>
    <Link
      to="/#contact"
      css={[
    ...
    >
      ...
      >
        ...
        <path fill="transparent" d="M12 14.5l-2.4-1.9-4.1 3.2v.3c0 .7.6 1.3 1.3 1.3h10.4c.7 0 1.3-.6 1.3-1.3v-.3l-4.1-3.2-2.4 1.9zM5.5 9.3v5.2l3.3-2.6zm11.7-2.7H6.8c-.7 0-1.3.6-1.3 1.3V8l6.5 5.2L18.5 8v-.1c0-.7-.6-1.3-1.3-1.3zm1.3 7.9V9.3l-3.3 2.6z" />
      </svg>
    </Link>
  </div>
);
